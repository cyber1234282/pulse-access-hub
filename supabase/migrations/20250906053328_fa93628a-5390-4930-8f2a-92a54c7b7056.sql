-- Create verification_codes table for custom OTP flow
...
-- Helpful indexes
create index if not exists idx_verification_codes_user_used on public.verification_codes (user_id, used);
